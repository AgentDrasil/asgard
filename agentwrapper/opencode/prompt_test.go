...
func TestExtractTargetFiles(t *testing.T) {
	...
	assert.Equal(t, []string{"/home/user/src/AgentDrasil/asgard/backend/README.md"}, extractTargetFiles("edit", map[string]any{"filePath": "/home/user/src/AgentDrasil/asgard/backend/README.md"}))
	...
	assert.Nil(t, extractTargetFiles("read", map[string]any{"filePath": "/home/user/src/AgentDrasil/asgard/backend/README.md"}))
