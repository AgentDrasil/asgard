...
# Install lightpanda
COPY docker-scripts/install-lightpanda.sh /tmp/install-lightpanda.sh
RUN chmod +x /tmp/install-lightpanda.sh && /tmp/install-lightpanda.sh --dir /bin && rm /tmp/install-lightpanda.sh
