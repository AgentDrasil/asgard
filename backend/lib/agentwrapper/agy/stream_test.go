...
{"event":"step_update","step_update":{"conversation_id":"57659af8-fee7-4694-8913-6ad09e91234a","step_index":4,"state":"ACTIVE","step_type":"tool","tool_name":"view_file","tool_info":{"name":"view_file","parameters":{"AbsolutePath":"/home/user/src/AgentDrasil/asgard/backend/go.mod"}}}}
{"event":"step_update","step_update":{"conversation_id":"57659af8-fee7-4694-8913-6ad09e91234a","step_index":4,"state":"DONE","step_type":"tool","tool_name":"view_file","duration_seconds":0.067443493,"tool_info":{"name":"view_file","parameters":{"AbsolutePath":"/home/user/src/AgentDrasil/asgard/backend/go.mod"},"output":"75 lines, 3057 bytes"}}}
...
func TestParseStream_Replay(t *testing.T) {
	...
	assert.Equal(t, streamCall{4, "TOOL", "tool_call", "> /home/user/src/AgentDrasil/asgard/backend/go.mod"}, calls[2])
	assert.Equal(t, streamCall{4, "TOOL", "tool_result", "> /home/user/src/AgentDrasil/asgard/backend/go.mod\n\n75 lines, 3057 bytes"}, calls[3])
